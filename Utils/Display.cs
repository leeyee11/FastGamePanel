...
namespace FastGamePanel.Utils
{
    ...
    internal class Display
    {
        ...
        /// <param name="width" />
        /// <param name="height" />
        public static bool ChangeDisplaySettings(int width, int height, int frequency)
        {
        ...
        #region GetSupportedDisplayModes
        public static List<DisplayMode> GetSupportedDisplayModes()
        {
            ...
            {
                DisplayMode mode;
                mode.width = vDevMode.dmPelsWidth;
                mode.height = vDevMode.dmPelsHeight;
                mode.frequency = vDevMode.dmDisplayFrequency;
